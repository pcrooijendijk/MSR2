...
PATTERNS: Dict[str, Pattern[str]] = {
    ...
    "denial_of_service": re.compile(r"(?i)(denial.of.service|\bdos\b|infinite.loop|\bReDoS\b)", re.IGNORECASE),
    "remote_code_execution": re.compile(r"(?i)(remote.code.execution|\bRCE\b|exploit|malicious)", re.IGNORECASE),
    ...
    "web_vulnerabilities_2": re.compile(r"(?i)(\bXSS\b|cross.site|\bXXE\b|\bopen.redirect|clickjack|session.fixation|hijack|x−frame−options|\bcross−oriдin\b|unauthori[z|s]ed)", re.IGNORECASE),
    "vulnerability_ids_1": re.compile(r"(?i)(\bCVE\b|\bCWE\b|\bNVD\b|\bvuln|advisory)", re.IGNORECASE),
